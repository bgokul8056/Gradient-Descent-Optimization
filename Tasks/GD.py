...
def main():
    ...
    for learning_rate in learning_rate_array:
        ...
        plt.title("Loss vs Number of Iterations with varying Learning rates for Gradient Descent without momentum")

    plt.legend(plots,learning_rate_array)
    plt.savefig("Loss plot for Gradient Descent without momentum")
