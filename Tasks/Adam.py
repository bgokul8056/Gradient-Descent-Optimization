...
def main():
    ...
    learning_rate_array = [0.00007,0.0007,0.0001]
    num_iterations = 300
    ...
    for learning_rate in learning_rate_array:
        ...
        # plt.title("Loss vs Number of Iterations with varying Learning rates for RMSProp")

    plt.legend(plots,learning_rate_array)
    plt.savefig("Loss plot for RMS Prop")
